...
{
    public class OpportunityStepMetricsQuery : IRequest<Response<List<OpportunityStepMetricDto>>>
    {
    ...
    public class OpportunityStepMetricsQueryHandler : IRequestHandler<OpportunityStepMetricsQuery, Response<List<OpportunityStepMetricDto>>>
    {
        ...
        public OpportunityStepMetricsQueryHandler(IRepositoryAsync<Opportunity> repositoryAsync, IRepositoryAsync<OpportunityStep> stepRepositoryAsync, IJwtService jwtService,
        ...
        public async Task<Response<List<OpportunityStepMetricDto>>> Handle(OpportunityStepMetricsQuery request, CancellationToken cancellationToken)
        {
