...
{
    public class CategoryTotalSalesMetricsQuery : IRequest<Response<List<CategorySaleMetricDto>>>
    {
    ...
    public class CategoryTotalSalesMetricsQueryHandler : IRequestHandler<CategoryTotalSalesMetricsQuery, Response<List<CategorySaleMetricDto>>>
    {
        ...
        public CategoryTotalSalesMetricsQueryHandler(IRepositoryAsync<Opportunity> repositoryAsync, IRepositoryAsync<Category> categoryRepositoryAsync)
        {
            _repositoryAsync = repositoryAsync;
            _categoryRepositoryAsync = categoryRepositoryAsync;
        }

        public async Task<Response<List<CategorySaleMetricDto>>> Handle(CategoryTotalSalesMetricsQuery request, CancellationToken cancellationToken)
        {
