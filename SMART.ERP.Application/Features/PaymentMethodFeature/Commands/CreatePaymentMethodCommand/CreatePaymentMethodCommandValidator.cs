...
public class CreatePaymentMethodCommandValidator : AbstractValidator<CreatePaymentMethodCommand>
{
    public CreatePaymentMethodCommandValidator()
    {
        ...
        RuleFor(p => p.CardNumber)
            ...
            .MaximumLength(19).WithMessage("El número de tarjeta no debe exceder {MaxLength} caracteres.")
            .MinimumLength(13).WithMessage("El número de tarjeta debe tener al menos {MinLength} caracteres.");
        ...
        RuleFor(p => p.CardBrand)
            ...
            .MaximumLength(20).WithMessage("La marca de la tarjeta no debe exceder {MaxLength} caracteres.");
    }
