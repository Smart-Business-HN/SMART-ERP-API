...
namespace SMART.ERP.Application.Features.AccountingReportFeature.Queries
{
    ...
    /// </summary>
    public class BalanceSheetQuery : IRequest<Response<BalanceSheetDto>>
    {
        public DateTime CutoffDate { get; set; }

        public class BalanceSheetQueryHandler : IRequestHandler<BalanceSheetQuery, Response<BalanceSheetDto>>
        {
            ...
            public BalanceSheetQueryHandler(IReadRepositoryAsync<JournalEntryLine> lineRepository)
            {
                _lineRepository = lineRepository;
            }

            public async Task<Response<BalanceSheetDto>> Handle(BalanceSheetQuery request, CancellationToken cancellationToken)
            {
                ...
                var dto = new BalanceSheetDto { CutoffDate = cutoff };
                ...
                return new Response<BalanceSheetDto>(dto);
            }
