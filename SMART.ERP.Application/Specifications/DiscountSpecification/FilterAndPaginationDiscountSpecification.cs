...
{
    public class FilterAndPaginationDiscountSpecification : Specification<Discount>
    {
        public FilterAndPaginationDiscountSpecification(string? parameter, int pageNumber,
