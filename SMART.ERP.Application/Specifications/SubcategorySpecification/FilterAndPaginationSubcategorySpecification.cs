...
{
    public class FilterAndPaginationSubcategorySpecification : Specification<Subcategory>
    {
        public FilterAndPaginationSubcategorySpecification(string? parameter, int pageNumber, int pageSize,
