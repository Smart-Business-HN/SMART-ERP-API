...
public sealed class FilterAndPaginationAssociatedCompanySpecification : Specification<AssociatedCompany>
{
    public FilterAndPaginationAssociatedCompanySpecification(Guid ecommerceUserId, string? parameter, int pageNumber, int pageSize, string? order, string? column)
    {
