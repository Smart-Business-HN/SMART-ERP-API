...
{
    public class FilterAndPaginationIncomeAccountSpecification : Specification<IncomeAccount>
    {
        public FilterAndPaginationIncomeAccountSpecification(string? parameter, int pageNumber,
