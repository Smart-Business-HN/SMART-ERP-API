...
{
    public class FilterAndPaginationPriceListSpecification : Specification<PriceList>
    {
        public FilterAndPaginationPriceListSpecification(string? parameter, int pageNumber,
