...
{
    public class FilterAndPaginationTypeStatusSpecification : Specification<TypeStatus>
    {
        public FilterAndPaginationTypeStatusSpecification(string? parameter, int pageNumber,
