...
{
    public class FilterAndPaginationInterestLevelSpecification : Specification<InterestLevel>
    {
        public FilterAndPaginationInterestLevelSpecification(string? parameter, int pageNumber, int pageSize,
