...
{
    public class PaginationTypeActivitySpecification : Specification<TypeActivity>
    {
        public PaginationTypeActivitySpecification(string? parameter, int pageNumber, int pageSize,
