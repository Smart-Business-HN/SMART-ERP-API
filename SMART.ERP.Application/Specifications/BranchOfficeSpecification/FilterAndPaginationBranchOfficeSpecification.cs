...
{
    public class FilterAndPaginationBranchOfficeSpecification : Specification<BranchOffices>
    {
        public FilterAndPaginationBranchOfficeSpecification(string? parameter, int pageNumber,
