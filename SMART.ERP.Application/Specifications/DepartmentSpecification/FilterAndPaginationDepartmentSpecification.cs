...
{
    public class FilterAndPaginationDepartmentSpecification : Specification<Department>
    {
        public FilterAndPaginationDepartmentSpecification(string? parameter, int pageNumber,
