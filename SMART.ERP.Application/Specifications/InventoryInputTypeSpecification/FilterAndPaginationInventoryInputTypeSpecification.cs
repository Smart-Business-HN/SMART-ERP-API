...
{
    public class FilterAndPaginationInventoryInputTypeSpecification : Specification<InventoryInputType>
    {
        public FilterAndPaginationInventoryInputTypeSpecification(string? parameter, int pageNumber,
