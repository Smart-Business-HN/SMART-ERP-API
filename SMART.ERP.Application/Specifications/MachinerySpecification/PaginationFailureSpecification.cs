...
{
    public class PaginationFailureSpecification : Specification<MachineryFailure>
    {
        public PaginationFailureSpecification(string? parameter, int pageNumber, int pageSize,
