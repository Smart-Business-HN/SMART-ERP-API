...
{
    public class PaginationWinReasonSpecification : Specification<WinReason>
    {
        public PaginationWinReasonSpecification(string? parameter, int pageNumber, int pageSize,
