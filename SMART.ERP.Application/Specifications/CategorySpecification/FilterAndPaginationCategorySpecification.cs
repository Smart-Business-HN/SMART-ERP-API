...
{
    public class FilterAndPaginationCategorySpecification : Specification<Category>
    {
        public FilterAndPaginationCategorySpecification(string? parameter, int pageNumber, int pageSize,
