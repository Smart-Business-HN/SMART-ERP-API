...
namespace SMART.ERP.Application.Services.MailService
{
    public class MailService : IMailService
    {
        ...
        public async Task SendEmailAsync(MailRequestDto mailRequest)
        {
            ...
            var platinoImage = builder.LinkedResources.Add("../SMART.ERP.Application/Assets/pm-logo.png");
            var sanyImage = builder.LinkedResources.Add("../SMART.ERP.Application/Assets/sany-logo.png");
            var whatsappImage = builder.LinkedResources.Add("../SMART.ERP.Application/Assets/whatsapp.png");
            var fbImage = builder.LinkedResources.Add("../SMART.ERP.Application/Assets/facebook.png");
            var instagramImage = builder.LinkedResources.Add("../SMART.ERP.Application/Assets/instagram.png");
