...
namespace SMART.ERP.Application.DTOs.MonthlySaleDeclaration
{
    public class MonthlySaleDeclarationDto
    {
        ...
        public List<DeclaredSaleInvoiceDto>? DeclaredSaleInvoices { get; set; }
    }
}
