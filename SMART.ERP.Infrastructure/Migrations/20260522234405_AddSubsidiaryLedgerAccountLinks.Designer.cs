...
namespace SMART.ERP.Infrastructure.Migrations
{
    ...
    [Migration("20260522234405_AddSubsidiaryLedgerAccountLinks")]
    partial class AddSubsidiaryLedgerAccountLinks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SMART.ERP.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<int?>("RevenueLedgerAccountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RevenueLedgerAccountId");
            ...
            modelBuilder.Entity("SMART.ERP.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasOne("SMART.ERP.Domain.Entities.LedgerAccount", "RevenueLedgerAccount")
                        .WithMany()
                        .HasForeignKey("RevenueLedgerAccountId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("RevenueLedgerAccount");
