...
namespace SMART.ERP.Infrastructure.Migrations
{
    ...
    [Migration("20260614203045_AddProductSubcategoryManyToMany")]
    partial class AddProductSubcategoryManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMART.ERP.Domain.Entities.CompetitorSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("LastObservedInStock")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("TaxBasis")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ProductId", "CompetitorName")
                        .IsUnique();

                    b.ToTable("CompetitorSource", (string)null);
                });
            ...
            modelBuilder.Entity("SMART.ERP.Domain.Entities.PriceChangeLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CompetitorSourceIdMin")
                        .HasColumnType("int");

                    b.Property<DateTime>("CreatedUtc")
                        .HasColumnType("datetime2");

                    b.Property<bool>("FloorHit")
                        .HasColumnType("bit");

                    b.Property<decimal?>("MinCompetitorPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("PriceChangeLog", (string)null);
                });
            ...
            modelBuilder.Entity("SMART.ERP.Domain.Entities.ProductSubcategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductId", "SubcategoryId")
                        .IsUnique();

                    b.ToTable("ProductSubcategoryLink", (string)null);
                });
            ...
            modelBuilder.Entity("SMART.ERP.Domain.Entities.RepricingRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MaxDecreasePercent")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");

                    b.Property<decimal>("MinChangeThreshold")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("UndercutMode")
                        .HasColumnType("int");

                    b.Property<decimal>("UndercutValue")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.ToTable("RepricingRule", (string)null);
                });

            modelBuilder.Entity("SMART.ERP.Domain.Entities.RepricingSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DefaultMaxDecreasePercent")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");

                    b.Property<decimal>("DefaultMinChangeThreshold")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DefaultMinMarginPercent")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");

                    b.Property<int>("DefaultRoundingMode")
                        .HasColumnType("int");

                    b.Property<int>("DefaultUndercutMode")
                        .HasColumnType("int");

                    b.Property<decimal>("DefaultUndercutValue")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<bool>("GlobalAutoApply")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("RepricingSettings", (string)null);
                });
